    ...
    render() {
      ...
      return (
        <div className="App">
          ...
          <div className="info-container">
            <div><h3><a href = "http://localhost:3000/Vaccine%20Information">Testing + Vaccine Information</a></h3><p> Find information on where to get tested in the Lewiston/Aurburn area as well as information on vaccination eligibility and clinic locations</p></div>
          </div>
          <div className="info-container">
